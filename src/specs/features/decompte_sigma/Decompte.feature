...
Feature: creerDecompte
  ...
  Scenario Outline: Creer Decompte  - cas passant
    ...
    And je saisie Nclient "353266"
    And je clique sur le boutton Rechercher
    And je clique sur container
    ...
    Examples: 
      ...
      |  353266 | Mme SS(A)    | 18/06/2021 | 18/06/2021    | Beneficiaire |     333413 | FRANCE | Hospitalisation | A00-B99 - Certaines maladies infectieuses et parasitaires | AUXILIAIRES MEDICAUX HOSP | AUXILIAIRES MEDICAUX HOSP | Prothèse médicale |         10 |            10 |   1 |
